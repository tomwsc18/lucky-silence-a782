...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/lucky-silence-a782#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lucky-silence-a782
```

A live public deployment of this template is available at [https://lucky-silence-a782.templates.workers.dev](https://lucky-silence-a782.templates.workers.dev)
